...
>
> **▶ ACTIVE = 1.2.2 (tax-correctness block), 5 of 7 done. Next action: 1.2.2.6** — the state
> picker. **⏸ 1.2.1 is 7/7 built**, deferred to ~November with Maestro.
> Health: **102** engine · **212** mobile unit · **34/34** Playwright · typecheck clean · lint 14.
>
